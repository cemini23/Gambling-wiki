...
- [x] In-season: weekly **slate hub** briefs in `briefs/` per @concepts/nfl-weekly-slate-hub-workflow.md — **K170** `briefs/2026-09-11_nfl-week1-slate-hub.md` (Sun 13-game dossier)
